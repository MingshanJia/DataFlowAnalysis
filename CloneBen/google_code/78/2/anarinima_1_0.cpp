...
int w[3][500][500];
ll sum[3][501][501];
int Sum(int d,int i0,int i1,int j0,int j1){
	int ans=sum[d][i1][j1]+sum[d][i0][j0]-sum[d][i1][j0]-sum[d][i0][j1];
	return ans-w[d][i1-1][j1-1]-w[d][i0][j1-1]-w[d][i1-1][j0]-w[d][i0][j0];
}
bool is_good(int i0,int i1,int j0,int j1){
	int w0=Sum(0,i0,i1,j0,j1);
	int w1=Sum(1,i0,i1,j0,j1);
	int w2=Sum(2,i0,i1,j0,j1);
