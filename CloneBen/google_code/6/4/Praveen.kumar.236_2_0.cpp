...
int a[1000010],b[300010],z=0,ans,c[311010],d[300010],mat[1001][1001],x,m,n;long double an[2000],S,D,S1,S2,X,Y,tim,te=0,tt=0,tt1=0;
...
for(i=0;i<=m;i++)
{
s+=(b[n-i]*modulo(2,i)%M)*comb(m,i,b,c)%M*(1-i%2*2);
}
s%=M;
if(s<0)s+=M;
cout<<s<<endl;
